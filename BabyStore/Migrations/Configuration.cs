namespace BabyStore.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BabyStore.Models.StoreContext>
    {
        ...
        protected override void Seed(BabyStore.Models.StoreContext context)
        {
            ...
            new Product { Name = "Orange and Yellow Lion", Description="Makes a squeakingnoise",
            ...
            new Product { Name = "3 Pack of Bottles", Description="For a leak freedrink everytime",
            Price =24.99M, CategoryID=categories.Single( c =>c.Name == "Feeding").ID},
            new Product { Name = "3 Pack of Bibs", Description="Keep your baby drywhen feeding",
            Price =8.99M, CategoryID=categories.Single( c => c.Name== "Feeding").ID },
            new Product { Name = "Powdered Baby Milk", Description="Nutritional andTasty",
            Price =9.99M, CategoryID=categories.Single( c => c.Name =="Feeding").ID },
            new Product { Name = "Pack of 70 Disposable Nappies", Description="Dry andsecure nappies with snug fit",
            ...
            new Product { Name = "Reflux Medicine", Description="Helps to prevent milkregurgitation and sickness",
            Price =4.99M, CategoryID=categories.Single(c => c.Name == "Medicine").ID },
            new Product { Name = "Black Pram and Pushchair System", Description="Convertfrom pram to pushchair, with raincover",
            ...
            new Product { Name = "Cot Bed", Description="Converts from cot into bed forolder children",
            Price =149.99M, CategoryID=categories.Single( c =>c.Name == "Sleeping").ID },
            new Product { Name = "Circus Crib Bale", Description="Contains sheet, duvetand bumper",
